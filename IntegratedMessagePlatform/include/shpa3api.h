...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	...
	//+++start+++	added by wangfeng for DST-24B Release, 2009.06.09
	int WINAPI SsmDstGetWorkMode(int ch); //added by yuyu, 2009.09.16
	...
	//+++ end +++	added by wangfeng for DST-24B Release, 2009.06.09
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	...
	int WINAPI SsmGetSs7Mtp2Msu(int ss7link, PUCHAR pucPara, PUCHAR* ppucMsuBuf);//modified by yuyu, 2009.09.17
	...
	int WINAPI SsmSetIsupParameter(int nBCh, UCHAR ucMsgTypeCode, UCHAR ucParamTypeCode,
								   WORD wLength, PUCHAR pucContent);
	int WINAPI SsmGetIsupParameter(int nBCh, UCHAR ucMsgTypeCode, UCHAR ucParamTypeCode,
								   PUCHAR pucContent, WORD wNumberOfBytesToWrite, LPWORD lpNumberOfBytesWritten);
	int WINAPI SsmSetTupParameter(int nBCh, UCHAR ucMsgTypeCode, UCHAR ucParamTypeCode,
								  WORD wLength, PUCHAR pucContent);
	...
	int WINAPI SsmSendSs7Mtp2Msu(int ss7link, WORD wMsuLength, PUCHAR pucMsuBuf); //added by yuyu, 2009.09.16
	int WINAPI SsmGetMaxSs7link();//added by yuyu, 2009.09.16
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@@@@ FAX OPERATION API @@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	...
	int WINAPI SsmIpGetUsingCodecType(int ch);	//added by netwolf for sc-4454 兼容5100以前的发布版本
	...
	int SsmIPGetStunPublicIP(int nBid,WORD nLocalPort,int nStunServerPort,LPSTR pstrStunServer,StunAddress4 *stunServerAdd,int flag);
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	...
	int WINAPI ShgSetISUPCAT(int nLocPcmNo, int nTs,  UCHAR ucCallerCAT);
	int WINAPI ShgHangupEx(int nLocPcmNo, int nTs, UCHAR ucCauseVal);
#else
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@@@@@@@@@@@ 独立网关客户端API @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	int WINAPI ShgSendSs7Msu(WORD wMsuLength, PUCHAR pucMsuBuf);
	int WINAPI ShgGetSs7Msu(PUCHAR* ppucMsuBuf);
